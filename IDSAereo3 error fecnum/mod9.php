...
$sql = "UPDATE pasonueve SET IUNO = '$inicialesuno',UNO = '$fecnumuno' WHERE (REF LIKE '$ref')";
...
<div class="container">
    ...
    <div class="row">
   	  <h4 class="alert-dismissible" style="text-align:center">
        	Responsable: Ejecutivo de Tráfico/ Asistente de Trafico
      </h4>
    </div>
    <div class="row">
