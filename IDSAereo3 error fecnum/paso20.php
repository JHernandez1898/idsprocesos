...
$sql = "INSERT INTO pasoveinte VALUES('$inicialesuno','$ref','$fecnumuno')";
$update = "UPDATE referencias SET paso = '21' WHERE(REF like '$ref') ";
...
<div class="container">
	<div class="row">
   	  <h1 class="page-header" style="text-align:center">
        	Facturacion de cuenta de gastos americana
      </h1>
    </div>
    <div class="row">
    <div class="row">
