...
$sql = "INSERT INTO pasodieciseis
VALUES('$inicialesuno','$ref','$fecnumuno')";
$update = "UPDATE referencias SET paso = '17' WHERE(REF like '$ref') ";
$queryu = mysqli_query($idCone,$update);
$query =  mysqli_query($idCone,$sql);
if($query&&$queryu){
	header("Location: paso17.php?ref=$ref");
}else{
...
<div class="container">
    ...
    <div class="row">
   	  <h4 class="alert-dismissible" style="text-align:center">
        	Responsable: Jefe de Bodega/Ejecutivo de Tráfico/ Asistente de Tráfico
      </h4>
    </div>
    <div class="row">
