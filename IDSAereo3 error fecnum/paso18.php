...
$sql = "INSERT INTO pasodieciocho VALUES('$inicialesuno','$ref','$fecnumuno')";
$update = "UPDATE referencias SET paso = '19' WHERE(REF like '$ref') ";
$queryu = mysqli_query($idCone,$update);
$query =  mysqli_query($idCone,$sql);
if($query&&$queryu){
	header("Location: paso19.php?ref=$ref");
}else{
...
<div class="container">
    ...
    <div class="row">
   	  <h4 class="alert-dismissible" style="text-align:center">
        	Responsable : Ejecutivo de Tráfico / Gerente
    </div>
    <div class="row">
