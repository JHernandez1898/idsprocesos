...
while($F = mysqli_fetch_array($query)){
	...
	$date1;
	$d1;
	$objPHPExcel->getActiveSheet()->getStyle($column.'6:'.$column.'C25') ->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::					
	FORMAT_DATE_TIME2);  
...
//AGREGAMOS LA FORMULA PARA SACAR LOS CALCULOS DE LAS HORAS O DIAS
...
$datetime2 = date_create($d11);
$interval = date_diff($datetime1, $datetime2);
$dias  = $interval->format("%a")  * 24;
$horas =  $interval->format("%H");
$total4 = $dias+$horas;

$datetime1 = date_create($d11);
...
$datetime2 = date_create($d14);
$interval = date_diff($datetime1, $datetime2);
$dias  = $interval->format("%a")  * 24;
$horas =  $interval->format("%H");
$total6 = $dias+$horas;

$datetime1 = date_create($d14);
...
$datetime2 = date_create($d19);
$interval = date_diff($datetime1, $datetime2);
$dias  = $interval->format("%a")  * 24;
$horas =  $interval->format("%H");
$total8 = $dias+$horas;

$datetime1 = date_create($d19);
$datetime2 = date_create($d21);
$interval = date_diff($datetime1, $datetime2);
$dias  = $interval->format("%a")  * 24;
$horas =  $interval->format("%H");
$total9 = $dias+$horas;
