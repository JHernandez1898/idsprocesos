...
$idos = $_POST["idos"];
$sql = "UPDATE pasonueve SET UNO = '$uno',IUNO = '$iuno',DOS = '$dos',IDOS = '$idos' WHERE (REF = '$ref')";
...
<div class="container">
	<div class="row">
   	  <h1 class="page-header" style="text-align:center">Confirmar depositos y equipo (Proceso...#9) </h1>
    </div>
    <div class="row">
    <article class="col-lg-12">
    <form accept-charset="iso-8859-7" action="#" method="post">
    <?php if($M = mysqli_fetch_array($pasonueve)){?>
