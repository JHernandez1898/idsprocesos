...
$sql = "UPDATE pasoquince SET UNO = '$uno',IUNO ='$iuno' WHERE(REF = $ref)";
...
<div class="container">
	<div class="row">
   	  <h1 class="page-header" style="text-align:center">Facturacion de cuenta de gastos americana (Proceso...#15) </h1>
  </div>
    <div class="row">
    <article class="col-lg-12">
    <form accept-charset="iso-8859-7" action="#" method="post">
    <?php if($M = mysqli_fetch_array($pasoquince)){?>
