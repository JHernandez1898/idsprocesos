...
$sql = "INSERT INTO pasodiecisiete VALUES('$inicialesuno','$ref','$fecnumuno')";
$update = "UPDATE referencias SET paso = '18' WHERE(REF like '$ref') ";
$queryu = mysqli_query($idCone,$update);
$query =  mysqli_query($idCone,$sql);
if($query&&$queryu){
	header("Location: paso18.php?ref=$ref");
}else{
...
<div class="container">
    ...
    <div class="row">
   	  <h4 class="alert-dismissible" style="text-align:center">
        	Responsable: Ejecutivo de trafico/Gerente
      </h4>
    </div>
    <div class="row">
