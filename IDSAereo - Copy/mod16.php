...
$sql = "UPDATE pasodieciseis SET IUNO = '$inicialesuno',UNO = '$fecnumuno' WHERE (REF LIKE '$ref')";
...
<div class="container">
    ...
    <div class="row">
   	  <h4 class="alert-dismissible" style="text-align:center">
        	Responsable: Jefe de Bodega/ Ejecutivo de Trafico/ Asistente de Trafico/ Gerente
      </h4>
    </div>
    <div class="row">
